                    ...
                    <div key={subcategory} className="border border-gray-200 rounded-lg overflow-hidden">
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <svg className={`w-4 h-4 text-gray-500 transition-transform ${isSubcatExpanded ? 'transform rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                          </svg>
                        </div>
                      </button>
                              ...
                              <div key={event.id}>
                                ...
                                >
                                  ...
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <svg className={`w-4 h-4 text-gray-400 transition-transform ${isEventExpanded ? 'transform rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                    </svg>
                                  </div>
                                </button>
                                ...
                                {isEventExpanded && (
                                  <div className="px-4 py-3 bg-gray-50 text-sm space-y-2">
                                    <div>
                                      ...
                                      <span className="text-gray-600">{formatDateTime(event)}</span>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                      ...
                                      <span className="text-gray-600">{event.calendarType}</span>
                                    </div>
                                    {event.description && (
                                      <div>
